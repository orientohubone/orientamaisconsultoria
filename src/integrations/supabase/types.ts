...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      services_catalog: {
        Row: {
          ...
          descricao: string | null;
          entregaveis: Json;
          forma_pagamento_padrao: Database["public"]["Enums"]["payment_method"] | null;
          id: string;
          nome: string;
    ...
    Enums: {
      ...
      lead_stage: "diagnostico" | "analise" | "estrategia" | "execucao" | "resultados";
      payment_method:
        | "a_vista"
        | "parcelado"
        | "recorrente_mensal"
        ...
        | "permuta"
        | "outro";
      proposal_item_status: "proposto" | "aprovado" | "em_execucao" | "entregue" | "cancelado";

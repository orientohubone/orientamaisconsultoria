...
function ServicosPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CrmShell, { title: "Catálogo de serviços", subtitle: "Modelos reutilizáveis para montar propostas dos clientes", actions, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-8 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl border border-border bg-card/60 backdrop-blur p-5", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-[0.65rem] font-bold uppercase tracking-wider text-primary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquareText, { className: "h-3.5 w-3.5" }),
          "Modelos gerais"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-lg font-bold", children: "Scripts-base para WhatsApp" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground max-w-3xl", children: "Use estes textos como ponto de partida para começar a prospecção. Eles já vêm com linguagem comercial leve e espaços para você adaptar ao serviço, ao cliente e ao momento da conversa." })
      ] }) }),
      copyFeedback && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-xs text-emerald-700 dark:text-emerald-300", children: copyFeedback }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid gap-3 md:grid-cols-2", children: GENERAL_WHATSAPP_TEMPLATES.map((template) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "rounded-2xl border border-border bg-background/70 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[0.65rem] font-bold uppercase tracking-wider text-muted-foreground", children: template.categoria }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 font-bold", children: template.titulo })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => copyScript(template.mensagem, template.titulo), className: "inline-flex items-center gap-1.5 rounded-lg border border-border px-2.5 py-1.5 text-[0.65rem] font-bold hover:border-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-3.5 w-3.5" }),
            " Copiar"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 whitespace-pre-wrap text-sm leading-6 text-muted-foreground", children: template.mensagem })
      ] }, template.titulo)) })
    ] }),
...
function ServiceCard({
  ...
  const [draft, setDraft] = reactExports.useState(svc.scripts_whatsapp.length > 0 ? svc : {
    ...svc,
    scripts_whatsapp: buildServiceWhatsAppScripts(svc)
  });
  ...
  function addScriptFromTemplate(template) {
    const next = template ? [...draft.scripts_whatsapp, createWhatsAppScript({
  ...
  function removeScript(idx) {
    setDraft({
      ...draft,
      scripts_whatsapp: draft.scripts_whatsapp.filter((_, i) => i !== idx)
    });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `group rounded-2xl border bg-card/70 backdrop-blur overflow-hidden transition ${draft.ativo ? "border-border hover:border-primary/40" : "border-border/50 opacity-70"}`, style: {
    ...
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-3 border-t border-border/50", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FieldMini, { label: "Scripts de prospecção via WhatsApp", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Crie os textos que sua equipe pode usar para abordar, fazer follow-up e retomar conversas sobre este serviço." }),
        draft.scripts_whatsapp.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-dashed border-border bg-secondary/30 p-4 text-sm text-muted-foreground", children: "Nenhum script criado ainda. Você pode inserir modelos prontos ou criar um do zero." }),
        draft.scripts_whatsapp.map((script, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-background/70 p-3 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 grid gap-2 md:grid-cols-[12rem_1fr]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: script.titulo, onChange: (e) => updateScript(idx, {
                titulo: e.target.value
              }), placeholder: "Título do script", className: "w-full rounded-lg bg-input border border-border px-3 py-2 text-sm focus:border-primary focus:outline-none" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: script.categoria, onChange: (e) => updateScript(idx, {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => removeScript(idx), className: "shrink-0 rounded-lg p-2 text-muted-foreground hover:text-destructive hover:bg-destructive/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: script.mensagem, onChange: (e) => updateScript(idx, {
            mensagem: e.target.value
          }), rows: 4, placeholder: "Escreva aqui o script para WhatsApp...", className: "w-full rounded-lg bg-input border border-border px-3 py-2 text-sm leading-6 focus:border-primary focus:outline-none resize-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[0.65rem] text-muted-foreground", children: "Dica: use placeholders como [nome], [segmento] ou [dor principal]." }) })
        ] }, script.id)),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => addScriptFromTemplate(), className: "inline-flex items-center gap-1.5 rounded-lg border border-border bg-background/60 px-3 py-2 text-xs font-bold hover:border-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-3.5 w-3.5" }),
            " Novo script"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => addScriptFromTemplate(GENERAL_WHATSAPP_TEMPLATES[0]), className: "inline-flex items-center gap-1.5 rounded-lg border border-border bg-background/60 px-3 py-2 text-xs font-bold hover:border-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3.5 w-3.5" }),
            " Inserir modelo geral"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: applyDefaultScripts, className: "inline-flex items-center gap-1.5 rounded-lg bg-primary text-primary-foreground px-3 py-2 text-xs font-bold hover:opacity-90", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquareText, { className: "h-3.5 w-3.5" }),

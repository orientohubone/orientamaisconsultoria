...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DEfJIMhu.mjs");
...
const manifest = {
  "1f09c2d87a98e98865ed585a8969dfe4752ba9b63f5bed110bdbfbb1cd83388a": {
    ...
    importer: () => import("./ai-orientacao.functions-22kn3yeg.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C_ho0nOs.mjs"),
    import("./start-B7ZVlLn2.mjs"),

...
const appCss = "/assets/styles-B_rNjcz7.css";
...
const faviconUrl = "/assets/favicon-orientamais-DIqnLMrn.png";
...
const $$splitComponentImporter$2 = () => import("./login-BSmEdcvw.mjs");
...
const $$splitComponentImporter$1 = () => import("./crm-D8bX3FF0.mjs");
...
const $$splitComponentImporter = () => import("./index-BKn0y95H.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Sessão de orientação gratuita: clareza, estratégia e direção para o seu negócio crescer com método. Garanta sua vaga."
    }, {
      property: "og:title",
      content: "Orientamais | Orientação Gratuita para Empreendedores"
    }, {
